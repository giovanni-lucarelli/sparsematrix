...
int main() {
    ...
    std::cout << "\n - Datatype of the matrix entry: " << typeid(csr(1,0)).name() << '\n';
    std::cout << " - Observation: the values are casted into integers!" << std::endl;
    ...
    std::vector<int> ones_vector = {1, 1, 1, 1};
    std::vector<int> result = csr * ones_vector;
    ...
    std::cout << "\n - Datatype of the matrix entry: " << typeid(coo(1,0)).name() << '\n';
    std::cout << " - Observation: the values are casted into integers!" << std::endl;
